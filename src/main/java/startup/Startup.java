...
public class Startup {
	...
	public static void main(String[] args) {
		...
		EmployeeService es = new EmployeeService(app.getEmployeeHandler());
		DepartmentService ds = new DepartmentService(app.getDepartmentHandler());

		// Creates the simple interaction client and
		// passes it the application handlers
		SimpleClient simpleClient = new SimpleClient(cs, ss, es, ds);
