 ...
 */
@Entity  
@NamedQuery(name=Product.FIND_BY_PRODUCT_ID, query="SELECT p FROM Product p WHERE p.prodCod = :" + 
		Product.PRODUCT_ID)

public class Product {

	// Named query name constants
	public static final String FIND_BY_PRODUCT_ID = "Product.getProdCod";
	public static final String PRODUCT_ID = "prodCod";
