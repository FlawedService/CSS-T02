...
public class CustomerCatalogUnitTest {
    ...
    public void addCustomerSuccess() throws ApplicationException {
    	...
    	given(new Customer(189663286, "Uma super empresa", 123, discount,"Filhos do homem")).willReturn(customer);
    	given(em.getTransaction()).willReturn(transaction);
    	
    	// when 
    	customerCatalog.addCustomer(189663286, "Uma super empresa", 123, discount, "Filhos do homem");
    ...
    public void addCustomerAlreadyExist() throws ApplicationException {
    	...
    	Discount discount = mock(Discount.class);
    	EntityTransaction transaction = mock(EntityTransaction.class);
    	given(new Customer(168027852, "Uma super empresa", 123, discount,"Filhas de mae")).willReturn(customer);
    	given(em.getTransaction()).willReturn(transaction);
    	willThrow(new PersistenceException()).given(transaction).commit();
    	
    	// when 
    	customerCatalog.addCustomer(189663286, "Uma super empresa", 123, discount, "Filhas de mae");
